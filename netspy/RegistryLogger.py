...
from netspy.RegistryMonitor import RegistryMonitor
...
class RegistryLogger(Pmw.MegaWidget):
  ...
  def _updateView(self):
	...
	message.append("AUDIENCE  = %s" % `event["BINDING"].serviceAudience()`)
	message.append("NETWORK   = %s" % `event["BINDING"].networkGroup()`)
